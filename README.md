...
[![Nuget](https://img.shields.io/nuget/v/SoftwareAteliers.FormApp.svg?style=flat&color=2196f3)](https://www.nuget.org/packages/SoftwareAteliers.FormApp/)
...
* Install the template from NuGet repository: `dotnet new -i SoftwareAteliers.FormApp`
